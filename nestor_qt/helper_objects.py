...
class QTableWidget_token(Qw.QTableWidget):
    ...
    def printDataframe_tableView(self):
        ...
        if self.dataframe is not None:
            ...
            # ignore score column
            self.setHorizontalHeaderLabels(temp_df.columns.tolist()[:-1])
...
class CompositionNGramItem:
    ...
    def printTokenView(self, layout, token, classification, notes, synonyms):
        ...
        text_classification.setObjectName(
    ...
    def clearLayout(self, layout):
        """recursive function that clear the widget
           and the layout inside a given layout
        ...
        #     Qw.QMessageBox.about(self, 'cannot plot',
        # "One of the axes you have selected is not in your database")
    ...
    #     self.update_progress_bar(self.progressBar_1gram_TagComplete,
    ...
    #     self.update_progress_bar(self.progressBar_Ngram_TagComplete,
